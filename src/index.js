...
const DAILY_GLOSSARIES = {
  ...
  "2026-09-03": {
    "emiti": { english: "emit, issue, transmit, broadcast", explanation: "To issue, transmit, or broadcast a signal. For example, TeleCuraçao emits a live stream of the Carnival parade straight to local homes." },
    "estetisismo": { english: "a devotion to artistic beauty", explanation: "A strong devotion to artistic beauty and visual appeal, such as the bright Caribbean colors used by local artists in Willemstad." },
    "item": { english: "item, entry, unit on a list", explanation: "A single entry or unit on a list. A baker checks every item off her morning list before opening her shop in Otrobanda." },
    "meimei": { english: "in the middle, center, halfway point", explanation: "Located in the middle, center, or halfway point. Landhuis Brakkeput Mei Mei gets its name from sitting in the middle of the historic plantation grounds." },
    "memo": { english: "memo, short written note", explanation: "A short written note used to share quick operational updates, such as a resort manager's note about an incoming cruise ship." },
    "mest": { english: "mix ingredients; organic fertilizer", explanation: "To mix ingredients or apply organic fertilizer. A farmer uses organic fertilizer to nourish an aloe vera crop in the countryside." },
    "meste": { english: "must, need to, be required to", explanation: "Expresses an essential need, requirement, or obligation. You must carry plenty of water when hiking up Mount Christoffel." },
    "mete": { english: "meddle, interfere", explanation: "To meddle or step into someone else's personal affairs, as neighbors may do while chatting across their garden fences." },
    "metí": { english: "entangled, involved, caught up", explanation: "To be entangled, deeply involved, or caught up in a situation. A fisherman's line can get metí in coral underwater." },
    "mimesis": { english: "artistic imitation, mimicry", explanation: "The artistic imitation of real-life human behavior and gestures. An actor uses mimesis to recreate traditional storytellers' expressive movements." },
    "mito": { english: "myth, legend, traditional story", explanation: "A traditional story, myth, or legend passed down through generations, such as a story about hidden pirate treasure in the Hato caves." },
    "omiti": { english: "omit, leave out, skip", explanation: "To intentionally leave out or skip a specific detail. A tour guide may omit long historical dates to keep children engaged." },
    "ompi": { english: "uncle; older family friend", explanation: "An affectionate, informal term for an uncle or older family friend. An ompi may fire up his grill every Sunday for a family beach barbecue." },
    "optimismo": { english: "optimism, hopeful outlook", explanation: "A hopeful, positive outlook regarding future outcomes. Hotel owners show optimism as island flight bookings surge." },
    "optimo": { english: "optimal, ideal, most favorable", explanation: "Describes the most ideal, perfect, or favorable condition. Sunny weather creates optimal conditions for diving at the Tugboat wreck." },
    "pesimismo": { english: "pessimism, expectation of poor results", explanation: "The expectation or belief that things will turn out poorly. Drivers express pessimism when rush-hour traffic hits the Queen Emma Bridge." },
    "pesimo": { english: "terrible, unpleasant, very poor", explanation: "Describes something dreadful, unpleasant, or of very low quality. Heavy rain can cause terrible underwater visibility along the coral reef." },
    "pimpi": { english: "sleek, stylish, sharply dressed", explanation: "Sleek, stylish, or sharply dressed in appearance. Drivers show off customized cars during weekend drives along Caracasbaai." },
    "pomp": { english: "pump", explanation: "A mechanical device used to move liquids or gas. An attendant uses a pump to fill gas tanks at a station in Saliña." },
    "potem": { english: "stalk, stem of a plant", explanation: "The main supporting stalk or stem of a plant. A gardener trims a thick stalk from a sugarcane plant in the countryside." },
    "semi": { english: "semi-, partly, halfway", explanation: "Indicates a partial state, half-level, or intermediate degree, as in a semi-professional windsurfer training in Sint Joris Bay." },
    "septimo": { english: "seventh", explanation: "Represents the seventh position in an ordered sequence. A family celebrates its seventh annual reunion with traditional cashew cake." },
    "sismo": { english: "earthquake, tremor", explanation: "A minor earth tremor or seismic vibration. Geologists measure a small earthquake tremor detected off the island's southern coast." },
    "smet": { english: "stain, blemish, mark", explanation: "A noticeable stain, blemish, or mark left on a surface. Iguana soup can leave a small stain on a white linen shirt." },
    "somete": { english: "submit, hand over for review", explanation: "To hand over work for review, judgment, or official approval. An architect submits new building plans to the city office in Punda." },
    "stem": { english: "vote, cast a vote, expression of opinion", explanation: "A formal vote, vocal choice, or official expression of opinion. Citizens use their vote during parliamentary elections to shape local policy." },
    "stom": { english: "foolish, reckless, unthinking", explanation: "Describes a foolish, unthinking, or reckless mistake. Leaving a phone unattended on a busy beach is a foolish mistake." },
    "stompi": { english: "blunt, dull, rounded", explanation: "Blunt, dull, or rounded at the cutting edge. A diver swaps out a dull blade before cutting tangled fishing lines." },
    "teim": { english: "thyme", explanation: "The aromatic culinary herb known as thyme. A cook adds fresh thyme to flavor fried piska kora at Plasa Bieu." },
    "teimoso": { english: "bothersome, persistent, nagging", explanation: "Bothersome, persistent, or nagging in an insistent way. An overly persistent street vendor can become bothersome when following tourists." },
    "teme": { english: "fear, be afraid of", explanation: "To feel fear or anxiety toward a potential danger. Swimmers fear strong undercurrents near the northern rocky cliffs." },
    "temi": { english: "feared, dreaded, held in awe", explanation: "Describes something widely feared, dreaded, or held in awe. Sailors respect the dangerous waves at Shete Boka." },
    "tempo": { english: "time, period, duration", explanation: "Refers to time, a period, or a duration. Friends spend quality time together at the beach while enjoying the afternoon sea breeze." },
    "tomo": { english: "tome, volume", explanation: "A tome or single volume in a multi-book collection. A historian pulls a heavy historical tome from the National Archives in Willemstad." },
  },
};
