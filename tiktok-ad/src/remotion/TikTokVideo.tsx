...
import {AnimF1, AnimF2, AnimF3, AnimF4, AnimF5} from '../App';
...
// Renderable equivalents of the browser Web Audio cues from App.tsx.
// Letter tap numbering intentionally continues from scene 2 into scene 4,
// matching the original tapCounter behavior.
...
export const TikTokVideo: React.FC = () => {
  ...
  const scenes = [AnimF1, AnimF2, AnimF3, AnimF4, AnimF5];
